...
urlpatterns = [
    ...
    path(
        "all-address-details/",
        views.UserAddressesListView.as_view(),
        name="all-address-details",
    ),
    path(
        "address-details/<int:pk>/",
        views.UserAddressDetailsView.as_view(),
        name="address-details",
    ),
    path(
        "create-address/", views.CreateUserAddressView.as_view(), name="create-address"
    ),
    path(
        "update-address/<int:pk>/",
        views.UpdateUserAddressView.as_view(),
        name="update-address-details",
    ),
    path(
        "delete-address/<int:pk>/",
        views.DeleteUserAddressView.as_view(),
        name="delete-address",
    ),
    # order
    path("all-orders-list/", views.OrdersListView.as_view(), name="all-orders-list"),
    path(
        "change-order-status/<int:pk>/",
