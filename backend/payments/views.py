...
#             user_data.append(
#                 {"user": {"card_num": the_card, "card_holder": each.email}}
#             )
...
#             return Response(
#                 {"detail": errorMessage}, status=status.HTTP_400_BAD_REQUEST
#             )
...
#                 email=request.data["email"], description="My new customer"
#             )
#         else:
#             customer = customer_data[0]
#             message = "Customer already exists"

#             actual_cn = customer.sources.data[
#                 0
#             ].last4  # holds card number (last four digits)
...
#             if (
#                 actual_cn != last4_recieved_cn
#                 or actual_em != recieved_em
#                 or actual_ey != recieved_ey
#             ):
#                 card_invalid = True

#         if card_invalid:
#             return Response(
#                 {"detail": "Invalid Card Details Provided."},
#                 status=status.HTTP_400_BAD_REQUEST,
#             )
...
#                 try:
#                     save_card_in_db(
#                         data, email, create_user_card.id, customer["id"], request.user
#                     )
#                     message = {
#                         "customer_id": customer["id"],
#                         "email": email,
#                         "card_data": create_user_card,
#                     }
